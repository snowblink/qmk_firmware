...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = KEYMAP_ARROW_COMMAND( /* Qwerty */
    ...
    TT(NUMPAD), KC_LCTL, KC_LALT, KC_LGUI,      KC_ENT,  KC_SPC,             KC_RALT, KC_LEFT, KC_DOWN,  KC_RIGHT
  ),

  [UPPER] = KEYMAP_ARROW_COMMAND( /* LAYER 1 */
    KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,
    _______, KC_BSLS, KC_QUOT, KC_MINS, KC_EQL,  KC_QUES, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
