...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [ARROWS] = KEYMAP_ARROW_COMMAND( /* LAYER 3 */
    ...
    _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    KC_PGUP,   _______, _______, _______, _______, _______, _______, _______, _______, KC_UP,   _______, _______,
    KC_PGDOWN, _______, _______, _______,          _______, _______,          KC_LEFT, KC_DOWN, KC_RIGHT, _______
  ),
};
