...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = KEYMAP(
    ...
    KC_TRANSPARENT,KC_TRANSPARENT, KC_TRANSPARENT,KC_UP,KC_TRANSPARENT,KC_TRANSPARENT, // 4th row
    KC_TRANSPARENT, // bottom big vertical
    KC_TRANSPARENT,KC_TRANSPARENT,KC_LEFT,KC_DOWN,KC_RIGHT, // bottom row
    KC_TRANSPARENT, KC_TRANSPARENT, // thumb top row
    KC_TRANSPARENT, // top thumblet
